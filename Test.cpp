...
TEST_CASE("Tests for add mothers or add fathers and relation/find") {
    ...
    T.addMother("Dina", "Zlil").addMother("Zlil", "Ziva").addMother("Ziva", "Yona");
            CHECK(T.relation("Avi") == string("it`s Me"));
    ...
    T.addFather("Avi", "Michael");
            CHECK(T.find("great-great-grandfather") == string("Bibi"));
            CHECK(T.find("great-great-great-grandfather") == string("Gigi"));
            CHECK(T.find("father") == string("Michael"));
            CHECK(T.relation("great-great-grandfather") == string("Bibi"));
            CHECK(T.relation("great-great-great-grandfather") == string("Gigi"));
            CHECK(T.relation("Michael") == string("father"));
    ...
    T2.remove("Or");
                ...
                CHECK_THROWS(T2.find("Or"));
                CHECK_THROWS(T2.find("aaa"));
                CHECK_THROWS(T2.find("bbb"));
                CHECK_THROWS(T2.find("Dan"));
                CHECK_THROWS(T2.find("Dina"));
                CHECK_THROWS(T2.find("Tony"));
